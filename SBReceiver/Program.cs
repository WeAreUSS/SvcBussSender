...
namespace SBReceiver
{
    class Program
    {
        private const string sbConnectionstring =
            "Endpoint=sb://usssvcbuss.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=V2rA/6eepv5VmQYTRfU2CTIAJuHVste9PeWCodxTBfU=";
